...
import { AddLeadButton, ExportButton } from "@/components/ui/action-buttons";
...
export default async function LeadsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between"><div><h1 className="text-xl font-semibold">Leads</h1><p className="text-sm text-muted mt-1">Prospects and lead capture • Export gratuit</p></div><div className="flex gap-2"><ExportButton type="customers" /><AddLeadButton /></div></div>
