...
export default function NewCoursePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (res.ok) router.push(`/courses/${data.id}`);
    setLoading(false);
  }
